...
https://www.youtube.com/watch?v=LGqsnM_WEK4&t=970s&ab_channel=ProgrammingWithNick
*/
...
public:
	...
	{
		Image image = LoadImage("gfx/food.png");
...
public:
	...
	{
		InitAudioDevice();
		eatSound = LoadSound("sfx/eat.mp3");
